...
public class Server3 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        new PingThread("localhost", 5001).start();
    ...
    private static class BackupListenerThread extends Thread {
        ...
        private void processBackupMessage(String message) {
            ...
            if (message.contains(",fromServer3")) {
                System.out.println("Server3'ten gelen mesaj alındı, ancak geri dönüş yapılmayacak.");
                return;
            }
    ...
    private static class AdminListenerThread extends Thread {
        ...
        public void run() {
            try (ServerSocket adminSocket = new ServerSocket(adminPort)) {
                ...
                adminSocket.setSoTimeout(10000); // 10 saniye zaman aşımı
        ...
        private String responseMessageToString(Message responseMessage) {
            ...
            switch (responseMessage.getDemand()) {
                ...
                case CPCTY:
                    ...
                    sendToPlotter("Server3:" + status);
                    return "server3_status:" + status + " Response: " + responseMessage.getResponse();
                case STRT:
                    return "Server3 started. Response: " + responseMessage.getResponse();
                default:
        ...
        private void sendToBackupServers(String message, int toleranceLevel) {
            ...
            for (int i = 0; i < limit; i++) {
                ...
                try (Socket backupSocket = new Socket(host, port);
                    ...
                    String messageToSend = message + ",fromServer3";
