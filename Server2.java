        ...
        private String responseMessageToString(Message responseMessage) {
            ...
            switch (responseMessage.getDemand()) {
                ...
                case CPCTY:
                    ...
                    sendToPlotter("Server2:" + status);
                    return "server2_status:" + status + " Response: " + responseMessage.getResponse();
                case STRT:
                    return "Server2 started. Response: " + responseMessage.getResponse();
                default:
        ...
        private void sendToBackupServers(String message, int toleranceLevel) {
            ...
            for (int i = 0; i < limit; i++) {
                ...
                try (Socket backupSocket = new Socket(host, port);
                    ...
                    String messageToSend = message + ",fromServer2";
